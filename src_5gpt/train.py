...
LastEditors: Aman
LastEditTime: 2022-01-26 00:57:35
'''
...
parser.add_argument("--save_path", default="./models/final_5ep_lr5e-6_bsz96_ln_5gpt", type=str, help="Save directory")
# parser.add_argument("--save_interval", default=1, type=int, help="Save interval")
parser.add_argument("--log_path", default="./logs/final_5ep_lr5e-6_bsz96_ln_5gpt.log", type=str, help="Log directory")
parser.add_argument("--tensorboard_log_dir", default="./logs/final_5ep_lr5e-6_bsz96_ln_5gpt", type=str, help="Tensorboard log directory")
...
def train(model, train_data, valid_data):
    ...
    for epoch in range(args.epochs):
        ...
        for step, batch in epoch_iterator:
            ...
            outputs = outputs.contiguous().view(outputs.shape[0], -1, outputs.shape[-1])
            targets = batch['targets'].contiguous().view(outputs.shape[0], -1) # [batch_size*seq_len*_max_sent_length*2]
