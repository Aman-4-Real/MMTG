...
LastEditors: Aman
LastEditTime: 2021-12-24 01:47:15
'''
...
def main():
    ...
    parser.add_argument("--model_path", default="./models/test2/model.pth", type=str, help="Model path")
    ...
    parser.add_argument("--temperature", default=1.2, type=float, required=False, help="生成温度")
