...
LastEditors: Aman
LastEditTime: 2021-12-16 11:41:47
'''
...
parser.add_argument("--lr", default=5e-05, type=float, help="Learning rate")
...
def train(model, train_data, valid_data):
    ...
    for epoch in range(args.epochs):
        ...
        for step, batch in epoch_iterator:
            ...
            writer.add_scalar('ppl', math.exp(loss.item()), global_steps)
