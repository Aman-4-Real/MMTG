...
LastEditors: Aman
LastEditTime: 2022-06-10 13:57:29
...
def main():
    ...
    parser.add_argument("--CUDA_VISIBLE_DEVICES", default="3,0,1,2", type=str, help="CUDA_VISIBLE_DEVICES")
    ...
    parser.add_argument("--save_samples_path", default="res/lr1e-5_bs96_kl02_add_tk1_tp0_tm1o1_rpt1o5_no_alpha_disorder.txt", type=str, required=False, help="保存样本的路径")
