...
LastEditors: Aman
LastEditTime: 2022-06-10 16:23:19
'''
...
def main():
    ...
    parser.add_argument("--CUDA_VISIBLE_DEVICES", default="1,0,2,3", type=str, help="CUDA_VISIBLE_DEVICES")
    ...
    parser.add_argument("--model_path", default="/data/caoqian/gen_exp/src_v8_rebuttal/models/lr1e-5_bs96_kl02_add_gilstm/epoch_5.pth", type=str, help="Model path")
    ...
    parser.add_argument("--save_samples_path", default="res/lstm_infer_time_test.txt", type=str, required=False, help="保存样本的路径")
