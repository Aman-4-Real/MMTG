...
LastEditors: Aman
LastEditTime: 2022-06-10 13:15:10
...
def main():
    ...
    parser.add_argument("--CUDA_VISIBLE_DEVICES", default="2,0,3,1", type=str, help="CUDA_VISIBLE_DEVICES")
    ...
    parser.add_argument("--model_path", default="/data/caoqian/gen_exp/src_v8_rebuttal/models/lr1e-5_bs96_kl02_add_gitrm/epoch_5.pth", type=str, help="Model path")
    ...
    parser.add_argument("--save_samples_path", default="res/lr1e-5_bs96_kl02_add_gitrm_tk1_tp0_tm1o1_rpt1o5_disorder.txt", type=str, required=False, help="保存样本的路径")
