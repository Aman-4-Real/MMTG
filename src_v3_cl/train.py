...
LastEditors: Aman
LastEditTime: 2021-12-23 15:17:05
'''
...
parser.add_argument("--lr", default=3e-05, type=float, help="Learning rate")
...
parser.add_argument("--train_data_path", default="../datasets/data_rating/train_data_with_ratings_80k.pkl", type=str, help="Train data path")
parser.add_argument("--val_data_path", default="../datasets/data_rating/val_data_with_ratings_5k.pkl", type=str, help="Val data path")
parser.add_argument("--save_model", default=True, type=bool, help="Save model or not")
parser.add_argument("--save_path", default="./models/test2", type=str, help="Save directory")
# parser.add_argument("--save_interval", default=1, type=int, help="Save interval")
parser.add_argument("--log_path", default="./logs/test2.log", type=str, help="Log directory")
parser.add_argument("--tensorboard_log_dir", default="./logs/test2", type=str, help="Tensorboard log directory")
...
class MyLoss(torch.nn.Module):
    ...
    def forward(self, _loss, ratings, stage):
        '''
        Args:
            _loss: (batch_size, seq_len)
            ratings: (batch_size)
        '''
        NEAR_0 = 1e-10
        device = _loss.device
...
def train(model, train_data, valid_data):
    ...
    train_dataset_1 = DataLoader(train_data, batch_size=4*batch_size, shuffle=True, num_workers=args.num_workers)
    valid_dataset_1 = DataLoader(valid_data, batch_size=4*val_batch_size, shuffle=True, num_workers=args.num_workers)
    ...
    for epoch in range(args.epochs):
        ...
        for step, batch in epoch_iterator:
            ...
            targets = batch['targets'].contiguous() # .view(-1) # [batch_size*seq_len*_max_sent_length*2]
