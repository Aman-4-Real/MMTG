...
LastEditors: Aman
LastEditTime: 2022-01-21 03:27:18
'''
...
parser.add_argument("--save_path", default="./models/final_5ep_lr5e-6_bsz96_ln", type=str, help="Save directory")
# parser.add_argument("--save_interval", default=1, type=int, help="Save interval")
parser.add_argument("--log_path", default="./logs/final_5ep_lr5e-6_bsz96_ln.log", type=str, help="Log directory")
parser.add_argument("--tensorboard_log_dir", default="./logs/final_5ep_lr5e-6_bsz96_ln", type=str, help="Tensorboard log directory")
