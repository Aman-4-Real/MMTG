...
LastEditors: Aman
LastEditTime: 2022-03-14 16:06:55
...
def main():
    ...
    os.environ["CUDA_VISIBLE_DEVICES"] = "0,1,2,3" # args.device_ids
    ...
    # =====> generate samples <=====
    while 1:
        f1 = open("res/final_lr1e-5_bs96_ln_newcl_kl02_tk10_tp07_tm1o1_rpt1o5_disorder.txt", "w", encoding="utf-8")
