...
LastEditors: Aman
LastEditTime: 2022-01-24 21:30:25
'''
...
parser.add_argument("--save_path", default="./models/final_5ep_1e-5_bsz96_wocl", type=str, help="Save directory")
# parser.add_argument("--save_interval", default=1, type=int, help="Save interval")
parser.add_argument("--log_path", default="./logs/final_5ep_1e-5_bsz96_wocl.log", type=str, help="Log directory")
parser.add_argument("--tensorboard_log_dir", default="./logs/final_5ep_1e-5_bsz96_wocl", type=str, help="Tensorboard log directory")
