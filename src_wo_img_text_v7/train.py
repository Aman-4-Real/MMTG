...
LastEditors: Aman
LastEditTime: 2022-04-04 22:52:28
'''
...
parser.add_argument("--save_path", default="./models/lr1e-5_bs96_kl02_add_wo_img", type=str, help="Save directory")
# parser.add_argument("--save_interval", default=1, type=int, help="Save interval")
parser.add_argument("--log_path", default="./logs/lr1e-5_bs96_kl02_add_wo_img.log", type=str, help="Log directory")
parser.add_argument("--tensorboard_log_dir", default="./logs/lr1e-5_bs96_kl02_add_wo_img", type=str, help="Tensorboard log directory")
