...
LastEditors: Aman
LastEditTime: 2022-01-25 19:32:21
'''
...
def main():
    ...
    parser.add_argument("--model_path", default="./models/final_5ep_lr5e-6_bsz96_ln_wotopic/epoch_3.pth", type=str, help="Model path")
    ...
    # =====> generate samples <=====
    while 1:
        f1 = open("res/samples_ln_lr1e-5_ep3_wo_topic.txt", "w", encoding="utf-8")
