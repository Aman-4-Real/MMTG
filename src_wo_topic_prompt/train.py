...
LastEditors: Aman
LastEditTime: 2022-01-25 11:21:22
'''
...
parser.add_argument("--save_path", default="./models/final_5ep_lr5e-6_bsz96_ln_wotopic", type=str, help="Save directory")
# parser.add_argument("--save_interval", default=1, type=int, help="Save interval")
parser.add_argument("--log_path", default="./logs/final_5ep_lr5e-6_bsz96_ln_wotopic.log", type=str, help="Log directory")
parser.add_argument("--tensorboard_log_dir", default="./logs/final_5ep_lr5e-6_bsz96_ln_wotopic", type=str, help="Tensorboard log directory")
...
class MyLoss(torch.nn.Module):
    ...
    def forward(self, outputs, targets, ratings, stage):
        ...
        shift_logits = outputs[:, self._seq_len:-1, :]
