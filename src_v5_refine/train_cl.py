...
parser.add_argument("--lr", default=2e-06, type=float, help="Learning rate")
...
parser.add_argument("--save_path", default="./models/lr2e-6_bs96_kl01", type=str, help="Save directory")
