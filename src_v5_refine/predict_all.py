...
LastEditors: Aman
LastEditTime: 2022-03-14 11:36:58
'''
...
def main():
    ...
    parser.add_argument("--temperature", default=1.3, type=float, required=False, help="生成温度")
    ...
    # =====> generate samples <=====
    while 1:
        f1 = open("res/lr1e-5_bs96_kl02_tk10_tp09_tm1o3_rpt1o5.txt", "w", encoding="utf-8")
