...
LastEditors: Aman
LastEditTime: 2022-03-28 19:21:54
'''
...
parser.add_argument("--save_path", default="./models/lr1e-5_bs96_kl02_wo_topic", type=str, help="Save directory")
# parser.add_argument("--save_interval", default=1, type=int, help="Save interval")
parser.add_argument("--log_path", default="./logs/lr1e-5_bs96_kl02_wo_topic.log", type=str, help="Log directory")
parser.add_argument("--tensorboard_log_dir", default="./logs/lr1e-5_bs96_kl02_wo_topic", type=str, help="Tensorboard log directory")
