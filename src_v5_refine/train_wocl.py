'''
Author: Aman
Date: 2022-03-26 15:01:40
Contact: cq335955781@gmail.com
LastEditors: Aman
LastEditTime: 2022-03-26 16:57:10
'''
...
parser.add_argument("--save_path", default="./models/5ep_1e-5_bsz96_wocl", type=str, help="Save directory")
# parser.add_argument("--save_interval", default=1, type=int, help="Save interval")
parser.add_argument("--log_path", default="./logs/5ep_1e-5_bsz96_wocl.log", type=str, help="Log directory")
parser.add_argument("--tensorboard_log_dir", default="./logs/5ep_1e-5_bsz96_wocl", type=str, help="Tensorboard log directory")
    ...
    for epoch in range(args.epochs):
        ...
        for step, batch in epoch_iterator:
            ...
            if step > 0 and (step + 1) % int(len(train_dataset) * args.val_interval_ratio) == 0:
                val_loss, ppl_loss, ppl, kldiv_loss = evaluate(model, valid_dataset, criterion)
