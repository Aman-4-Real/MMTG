...
LastEditors: Aman
LastEditTime: 2022-01-17 00:19:31
'''
...
def main():
    ...
    parser.add_argument("--data_path", default="../datasets/new_data_rating/final_test_153.pkl", type=str, help="Data directory")
    parser.add_argument("--model_path", default="./models/wo_img_5ep_1e-5_bsz96_cl/epoch_3.pth", type=str, help="Model path")
    ...
    parser.add_argument("--topk", default=3, type=int, required=False, help="最高几选一")
