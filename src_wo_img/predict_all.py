...
LastEditors: Aman
LastEditTime: 2022-01-23 01:35:39
'''
...
def main():
    ...
    parser.add_argument("--model_path", default="./models/final_wo_img_5ep_1e-5_bsz96_cl_ln/epoch_3.pth", type=str, help="Model path")
    ...
    # =====> generate samples <=====
    while 1:
        f1 = open("res/samples_wo_img_lr1e-5_ep3.txt", "w", encoding="utf-8")
        # f2 = open("res/labels_wo_img_ep5.txt", "w", encoding="utf-8")
